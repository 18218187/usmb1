...
export class SecondaryChannelEmail {
  constructor(
    secondaryChannelIdentifierUpdater,
    secondaryChannelExternalUserIdUpdater,
    secondaryChannelTagsUpdater,
    secondaryChannelSessionUpdater,
    secondaryChannelFocusUpdater
  ) {
    this.secondaryChannelIdentifierUpdater = secondaryChannelIdentifierUpdater;
    this.secondaryChannelExternalUserIdUpdater =
      secondaryChannelExternalUserIdUpdater;
  ...
  async updatePushPlayersRelationToEmailPlayer(
